...
public class Program {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        try(FileOutputStream fileOutputStream = new FileOutputStream("./src/main/java/sem3/task01/userdata.bin");
            ObjectOutputStream objectOutputStream = new ObjectOutputStream(fileOutputStream)){
            objectOutputStream.writeObject(user);
            System.out.println("Объект UserData сериализован.");
        }

        try(FileInputStream fileInputStream = new FileInputStream("./src/main/java/sem3/task01/userdata.bin");
