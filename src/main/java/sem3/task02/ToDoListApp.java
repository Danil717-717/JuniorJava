...
public class ToDoListApp {
    ...
    public static final String FILE_JSON = "./src/main/java/sem3/task02/tasks.json";
    public static final String FILE_BIN = "./src/main/java/sem3/task02/tasks.bin";
    public static final String FILE_XML = "./src/main/java/sem3/task02/tasks.xml";
